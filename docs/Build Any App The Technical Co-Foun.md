...
* Use Korean for all conversations, status reports, and documentation (including .md files) that require my review.
* Maintain English for all technical source code.
